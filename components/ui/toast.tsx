...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-slate-200 bg-transparent px-3 text-sm font-medium ring-offset-white transition-colors hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.border-red-500]:border-slate-100/40 group-[.border-red-500]:hover:border-red-500/30 group-[.border-red-500]:hover:bg-red-500 group-[.border-red-500]:hover:text-slate-50 group-[.border-red-500]:focus:ring-red-500 dark:border-slate-800 dark:ring-offset-slate-950 dark:hover:bg-slate-800 dark:focus:ring-slate-300 dark:group-[.border-red-500]:border-slate-800/40 dark:group-[.border-red-500]:hover:border-red-900/30 dark:group-[.border-red-500]:hover:bg-red-900 dark:group-[.border-red-500]:hover:text-slate-50 dark:group-[.border-red-500]:focus:ring-red-900",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-slate-950/50 opacity-0 transition-opacity hover:text-slate-950 focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.border-red-500]:text-red-300 group-[.border-red-500]:hover:text-red-50 group-[.border-red-500]:focus:ring-red-400 group-[.border-red-500]:focus:ring-offset-red-600 dark:text-slate-50/50 dark:hover:text-slate-50",
      className
    )}
    toast-close=""
    {...props}
